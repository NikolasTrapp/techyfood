package br.example.security.config.security.oauth;

import br.example.security.utils.RecebaSecurityProperties;
...
public class OAuth2Config {
    ...
    @Bean
    public AuthorizationServerSettings authorizationServerSettings(RecebaSecurityProperties properties) {
