package br.techyfood.security.config.security.oauth;

import br.techyfood.security.utils.RecebaSecurityProperties;
...
public class OAuth2Config {
    ...
    public SecurityFilterChain authFilterChain(HttpSecurity http) throws Exception {
        http.csrf(c -> c.ignoringRequestMatchers("/user/register"))
