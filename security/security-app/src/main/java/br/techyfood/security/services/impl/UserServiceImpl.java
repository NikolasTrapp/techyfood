package br.techyfood.security.services.impl;
...
import br.techyfood.security.exceptions.RegisterException;
import br.techyfood.security.repositories.RoleRepository;
import br.techyfood.security.repositories.UserRepository;
...
public class UserServiceImpl implements UserService {
    ...
    private final UserVisitor userVisitor;
    ...
    public UserEntity registerUser(UserDto user) {
        ...
        userVisitor.visitAfterCreate(userEntity);
        return savedUser;
    }
    ...
    private void validateUser(UserDto user) throws RegisterException {
        ...
        if (userExists) {
            throw new RegisterException("An user already exists with provided username or email.");
        }
    }
